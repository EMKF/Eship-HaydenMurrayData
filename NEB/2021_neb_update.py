...
def data_create():
    ...
    df = pd.read_csv('/Users/hmurray/Desktop/NEB/2021/data/2021_neb_download.csv')
    # filter df for US
...
def table_1(df):
    ...
    # df.to_excel('/Users/hmurray/Desktop/NEB/2021/data/national_report/table_1.xlsx')
    return df

def ba_reference():
    # import ba numbers
    ba = pd.read_excel('/Users/hmurray/Desktop/NEB/2021/data/national_report/ba_reference.xlsx')
    # rename columns
    ...
    # axes = plt.gca()
    plt.tight_layout()
    plt.savefig('/Users/hmurray/Desktop/NEB/2021/data/national_report/fig1_ba_plot.png')
    plt.show()

def actualization_plots(df):
    df.plot(x='year', y=['actualization'])
    plt.title("\n".join(wrap("Figure 2: In 2005, approximately one in five new businesses across the United States"
    ...
    plt.tight_layout()
    axes.set_ylim([0, .35])
    plt.savefig('/Users/hmurray/Desktop/NEB/2021/data/national_report/fig2_actualization.png')
    plt.show()
    return df

def rate_new_emp_bus_plots(df):
    df.plot(x='year', y=['rate_new_employer_business'])
    plt.title("\n".join(wrap("Figure 3: In 2005, approximately 160 new employer businesses were formed for every"
    ...
    plt.tight_layout()
    axes.set_ylim([0, .20])
    plt.savefig('/Users/hmurray/Desktop/NEB/2021/data/national_report/fig3_rate_new_emp.png')
    plt.show()
    return df

def velocity_plots(df):
    df.plot(x='year', y=['velocity'])
    plt.title("\n".join(wrap("Figure 4: In 2005, it took roughly one and a half quarters for a new business to become an employer"
    ...
    plt.tight_layout()
    axes.set_ylim([0, 2.5])
    plt.savefig('/Users/hmurray/Desktop/NEB/2021/data/national_report/fig4_velocity.png')
    plt.show()
    return df
...
def newness_plots(df):
    ...
    plt.tight_layout()
    axes.set_ylim([0, .12])
    plt.savefig('/Users/hmurray/Desktop/NEB/2021/data/national_report/fig5_newness.png')
    plt.show()
    return df
...
def nebas_index_plots(df):
    ...
    plt.title("\n".join(wrap("Figure 6: The NEBAS Index has decreased every year for which data are available,"
    ...
    plt.tight_layout()
    axes.set_ylim([0, 1.5])
    plt.savefig('/Users/hmurray/Desktop/NEB/2021/data/national_report/fig6_nebas_index.png')
    plt.show()
    return df
