# data downloaded manually from https://factfinder.census.gov/bkmk/table/1.0/en/ASE/2016/00CSCBO11
...
rne = rne[52:54]
rne.to_excel('/Users/hmurray/Desktop/data/ASE/MO/why_own/data_own/kese_own/rne_gender.xlsx', index=False)

# NEB - Rate of New Employer Businesses output
rneb = pd.read_csv('/Users/hmurray/Desktop/data/ASE/MO/why_own/data_own/neb/NEB_rate.csv')
rneb = rneb[51:52]
rneb.to_excel('/Users/hmurray/Desktop/data/ASE/MO/why_own/data_own/rneb_us.xlsx', index=False)

# KESE - OPPORTUNITY SHARE OF ENTREPRENEURS
kese = pd.read_csv('/Users/hmurray/Desktop/KESE/KESE_2018_data/KESE_opp.csv')

# United States OSE
kese_us = kese[51:52]
kese_us = kese_us.iloc[:,:26]
kese_us.to_excel('/Users/hmurray/Desktop/data/ASE/MO/why_own/data_own/kese_own/kese_opp_US.xlsx', index=False)
print(kese_us)

# Gender OSE
kese_gender = kese[(kese.demographic == 'Men') | (kese.demographic == 'Women')]
kese_gender = kese_gender.iloc[:,:26]
kese_gender.to_excel('/Users/hmurray/Desktop/data/ASE/MO/why_own/data_own/kese_own/kese_opp_gender.xlsx', index=False)
print(kese_gender)
...
print(kese_race)
kese_race.to_excel('/Users/hmurray/Desktop/data/ASE/MO/why_own/data_own/kese_own/kese_opp_race.xlsx', index=False)

# ASE - REASONS WHY ENTREPRENEURS OWN THEIR BUSINESS
# import data
df = pd.read_csv('/Users/hmurray/Desktop/data/ASE/MO/why_own/data_own/original_pull/ASE_2016_reasons_own_business.csv')
...
df_all.to_excel('/Users/hmurray/Desktop/data/ASE/MO/why_own/data_own/all_reasons_own_bus.xlsx', index=False)
print(df_all)
...
df_gender.to_excel('/Users/hmurray/Desktop/data/ASE/MO/why_own/data_own/gender_reasons_own_bus.xlsx', index=False)
print(df_gender)
...
df_race.to_excel('/Users/hmurray/Desktop/data/ASE/MO/why_own/data_own/race_reasons_own_bus.xlsx', index=False)
print(df_race)

# observation filter: race very important
df_all_very = df_all[df_all['reason'].str.contains("Very")]
df_all_very.to_excel('/Users/hmurray/Desktop/data/ASE/MO/why_own/data_own/very_own/very_all_reasons_own_bus.xlsx', index=False)

# observation filter: gender very important
df_gender_very = df_gender[df_gender['reason'].str.contains("Very")]
df_gender_very.to_excel('/Users/hmurray/Desktop/data/ASE/MO/why_own/data_own/very_own/very_gender_reasons_own_bus.xlsx', index=False)

# observation filter: race very important
df_race_very = df_race[df_race['reason'].str.contains("Very")]
df_race_very.to_excel('/Users/hmurray/Desktop/data/ASE/MO/why_own/data_own/very_own/very_race_reasons_own_bus.xlsx', index=False)
...
matplotlib_plot(plot_us, ['United States'], '/Users/hmurray/Desktop/data/ASE/MO/why_own/data_own/plots/us_ose.png')
gender = ['Men', 'Women']
matplotlib_plot(plot_gender, gender, '/Users/hmurray/Desktop/data/ASE/MO/why_own/data_own/plots/gender_ose.png')
race = ['White', 'Black', 'Latino', 'Asian']
matplotlib_plot(plot_race, race, '/Users/hmurray/Desktop/data/ASE/MO/why_own/data_own/plots/race_ose.png')
