...
# pull raw data
raw = pd.read_excel('/Users/hmurray/Desktop/data/general_content/financial_means/python/small_bus_pulse/national_sector_10May20_16May20.xls', na_values='-')
raw = raw[pd.isnull(raw['NAICS2'])]
raw["ID"] = raw["INSTRUMENT_ID"].astype(str) + ' - ' + raw["ANSWER_ID"].astype(float).astype(str)

# pull codebook
code = pd.read_excel('/Users/hmurray/Desktop/data/general_content/financial_means/python/small_bus_pulse/codebook.xls')
...
writer = pd.ExcelWriter('/Users/hmurray/Desktop/data/general_content/financial_means/python/small_bus_pulse/clean_survey_data.xlsx', engine='xlsxwriter')
