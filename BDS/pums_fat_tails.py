...
# writer
writer = pd.ExcelWriter('/Users/hmurray/Desktop/data/PUMS/p90_p10/csv_pus/us_output.xlsx', engine='xlsxwriter')

def data_create():
    df = pd.DataFrame()
    for csv in os.listdir('/Users/hmurray/Desktop/data/PUMS/p90_p10/csv_pus/'):
        print(csv)
        data = pd.read_csv('/Users/hmurray/Desktop/data/PUMS/p90_p10/csv_pus/' + str(csv), low_memory=False)
